...
def seller_to_type(seller) -> SellerType:
    ...
    return SellerType(
        ...
        store_address=seller.store_address or None,
        opens_at=seller.opens_at.strftime("%H:%M") if seller.opens_at else None,
        closes_at=seller.closes_at.strftime("%H:%M") if seller.closes_at else None,
