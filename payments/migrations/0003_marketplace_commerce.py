...
class Migration(migrations.Migration):
    dependencies = [
        ("payments", "0002_payment_country_code_alter_payment_currency_and_more"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("disabled", "Classified only"),
                            ("optional", "Optional checkout"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("pix", "Pix"), ("bank_account", "Bank account")],
                        max_length=20,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "method",
                    models.CharField(
                        choices=[("pix", "Pix"), ("card", "Card")], max_length=12
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("seller_receivable", "Seller receivable"),
                            ("refund", "Refund"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["seller", "kind", "created_at"], name="commerce_led_seller_idx"
            ),
        ),
